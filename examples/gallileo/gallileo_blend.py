...
cog_offset = [.1, 0, 0] # this offsets the inertial center of gravity
...
euler_angle = euler2quat(np.vstack([psi, theta, phi]).transpose(), 'zxz')
...
craft = bpsci_core.dyn_obj(bpy.data.objects['gallileo'], euler_pa, cog_offset, euler_type, None, anim)  #the dynamic object that represents the Gallileo spacecraft
